...
suite('Cooper — activation & commands', () => {
    ...
    test('contributes its commands', async () => {
        ...
        for (const c of ['cooper.build', 'cooper.preview', 'cooper.configureClangd', 'cooper.refresh', 'cooper.debug', 'cooper.home', 'cooper.openWalkthrough', 'cooper.editPalette', 'cooper.editTiles', 'cooper.viewTilemap', 'cooper.configureAI']) {
